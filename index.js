...
const bookContainer = document.querySelector('.search')
const searchBooks = document.getElementById('search-box')
...
const mainNavLinks = document.querySelectorAll('.scrolltoview')
window.addEventListener('scroll', (event) => {
  const fromTop = window.scrollY + 64
